    ...
    return (
      <div className="card flex items-center gap-2.5 !py-2.5 !px-3 cursor-pointer animate-fade-in"
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={(e) => { e.stopPropagation(); if (!user) return; toggleFavorite(p.id); }} className="p-1 bg-transparent border-none cursor-pointer">
  ...
  return (
    <div className="px-4 pt-4 max-w-[640px] mx-auto">
      ...
      <div className="relative mb-2.5">
        ...
        <input className="input-field !pl-9" placeholder="Buscar equipo o usuario..." value={search} onChange={e => setSearch(e.target.value)} />
      </div>
      ...
      {selectedTeam && (
        <div className="fixed inset-0 z-[200] bg-black/70 backdrop-blur-sm flex items-end justify-center" onClick={() => setSelectedTeam(null)}>
          <div className="bg-bg-4 rounded-t-[20px] w-full max-w-[640px] max-h-[85vh] overflow-y-auto p-5 animate-slide-up" onClick={e => e.stopPropagation()}>
