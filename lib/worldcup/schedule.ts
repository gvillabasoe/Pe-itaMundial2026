...
export const WORLD_CUP_MATCHES: WorldCupMatch[] = [
  ...
  m(23, "group", "Portugal", "RD del Congo", "Houston", "Fase de Grupos"),
  ...
  m(48, "group", "Colombia", "RD del Congo", "Guadalajara", "Fase de Grupos"),
  ...
  m(72, "group", "RD del Congo", "Uzbekistán", "Atlanta", "Fase de Grupos"),
